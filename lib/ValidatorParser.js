...
export default class ValidatorParser {
    ...
    parseTypeDeclaration() {
        ...
        while (this.isNotType(ValidatorLexeme.RCURLY)) {
            propertyGroups.push(this.parsePropertyDescriptions());
        }
    ...
    parsePropertyDescriptions() {
        ...
        while (this.isNotType(ValidatorLexeme.RCURLY)) {
            descriptions.push(this.parseDescriptionGroup());
        }
    ...
    parseDescriptionGroup() {
        const groups = [];

        switch (this.lexeme.type) {
            case ValidatorLexeme.IDENTIFIER:
                groups.push(this.parseDescription());
                break;
            case ValidatorLexeme.GROUP:
                ...
                break;
            default:
                this.error("Expected identifier or 'group' keyword");
        }
