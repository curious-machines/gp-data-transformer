...
const grammar = {
    ...
    bnf: {
        ...
        group: [
            ...
            [ "stringOrIdentifier : typePattern", "$$ = { type: 'group', matches: [ { type: 'match', name: $1, patterns: [ $3 ] } ] };" ]
        ],
        patternMatches: [
        ...
        typePattern: [
            ...
            [ "arrayPattern", "$$ = { type: 'pattern', patternType: 'array-pattern', value: $1 };" ],
            ...
            [ "NUMBER", "$$ = { type: 'pattern', patternType: 'number', value: $1 };" ],
            [ "OBJECT_TYPE", "$$ = { type: 'pattern', patternType: 'object', value: null };" ],
            [ "objectPattern", "$$ = { type: 'pattern', patternType: 'object-pattern', value: $1 };" ],
        ...
        // array pattern
        arrayPattern: [
            [ "[ ]", "$$ = { type: 'pattern', value: 'array' };" ],
            [ "[ elements ]", "$$ = { type: 'array-pattern', value: $2 };" ]
        ],
        elements: [
        ...
        // object pattern
        objectPattern: [
            [ "{ }", "$$ = { type: 'pattern', value: 'object' };" ],
            [ "{ properties }", "$$ = { type: 'object-pattern', value: $2 };" ]
        ],
        properties: [
        ...
        namedProperty: [
            ...
            [ "property AS IDENTIFIER", "$3.assignTo = $1; $$ = $3;" ]
        ],
        property: [
