...
const grammar = {
    ...
    bnf: {
        ...
        statement: [
            [ "transformSequence", "$$ = { type: 'transform-sequence', transforms: $1 };" ],
            ...
            [ "ENUMERATION IDENTIFIER = { identifiers }", "$$ = { type: 'enumeration-assignment', name: $2, value: $5 };" ],
        ],

        // transforms
        transformSequence: [
            [ "transformSequence ; transform", nextInList2 ],
        ...
        transform: [
            ...
            [ "<= typePatterns", "$$ = { type: 'transform', patterns: $2, returnValue: null };" ],
            ...
            // NOTE: Don't think these belong here
