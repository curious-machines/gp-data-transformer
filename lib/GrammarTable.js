...
const grammar = {
    ...
    bnf: {
        ...
        assignment: [
            ...
            [ "DEF IDENTIFIER = transformSequence", "$$ = { type: 'def', name: $2, value: $4 };" ],
        ],
        ...
        step: [
            ...
            [ "SEQ IDENTIFIER", "$$ = { type: 'sequence-ref', name: $2 };" ]
        ],
        ...
        expression: [
            ...
            [ "MATCH ( patterns )", "$$ = { type: 'match', patterns: $3 };" ]
        ],
        mathExpression: [
        ...
        expressionProperty: [
            [ "expression : transformSequence", "$$ = { type: 'property', name: $1, value: $3 };" ],
