...
const grammar = {
    ...
    bnf: {
        ...
        transform: [
            [ "generator",                 `$$ = { type: 'transform', patterns: [${anyPattern}], returnValue: $1 };` ],
        ...
        generator: [
            ...
            [ "MAP ( generator , transform )", "$$ = { type: 'generator', expression: { type: 'map', value: [ $3, $5 ] } };" ],
            [ "memberExpression", passThrough ],

            // NOTE: these are for testing. They will need to be generalized
            [ "generator + generator", "$$ = { type: 'generator', expression: { type: 'add', left: $1, right: $3 } };" ],
            [ "generator - generator", "$$ = { type: 'generator', expression: { type: 'subtract', left: $1, right: $3 } };" ],
            [ "generator * generator", "$$ = { type: 'generator', expression: { type: 'multiply', left: $1, right: $3 } };" ],
            [ "generator / generator", "$$ = { type: 'generator', expression: { type: 'divide', left: $1, right: $3 } };" ],
            // [ "( generator )", "$$ = $2;" ]
        ],
        memberExpression: [
            [ "primaryExpression", passThrough ],
            [ "memberExpression . IDENTIFIER", "$$ = { type: 'generator', expression: { type: 'get-property', left: $1, right: $3 } };"],
            [ "memberExpression . integer",    "$$ = { type: 'generator', expression: { type: 'get-index', left: $1, right: $3 } };"],
        ...
        parameterList: [
            [ "parameterList , parameter", nextInList2 ],
            [ "parameter", firstInList ]
        ],
        parameter: [
            [ "generator", passThrough ],
            [ "... IDENTIFIER", "$$ = { type: 'generator', expression: { type: 'spread', name: $2 } };" ]
        ],
