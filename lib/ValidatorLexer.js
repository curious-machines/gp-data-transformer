...
const KEYWORD_MAP = {
    from: ValidatorLexeme.FROM,
    group: ValidatorLexeme.GROUP,
    "type-match": ValidatorLexeme.TYPE_MATCH
};
const OPERATOR_MAP = {
    "(": ValidatorLexeme.LPAREN,
    ")": ValidatorLexeme.RPAREN,
